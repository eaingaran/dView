# dWorker
dWorker reads data from files and populates the database (mysql) which will be used by dREST and dUI for presenting in the WebPage.
...
== Create a new Processor Job for your Spring application

`src/main/java/xyz/fullstack/development/job/FileProcessor.java`
[source,java]
----
include::src/main/java/xyz/fullstack/development/job/FileProcessor.java
----

NOTE: This class contains the business logic to map the csv content to domain and to persist in the database.
